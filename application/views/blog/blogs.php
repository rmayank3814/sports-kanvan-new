    ...
    <div class=" table-responsive-sm">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-9"><h2>Blog <b>Details</b></h2></div>
                    <div class="col-sm-3">
                        <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"> <span>Add New Blog</span></a>
                    </div>
                </div>
            </div>
            <!-- Add Modal HTML -->
                    ...
                    <div class="modal-content">
                            ...
                            <div class="modal-body">				
                                <div class="form-group">
                                    <label>Image:<span class="text-danger font-weight-medium">*</span></label>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><?=$bannerData['author']?></td>
                        <td><?=$bannerData['content']?></td>
                        <td>
