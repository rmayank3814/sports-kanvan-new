...
<aside class="side-nav" id="show-side-navigation1">
  ...
  <div class="heading">
  <img src="<?php echo base_url();?>main/images/admin.jpg" alt="admin dashboard" class="img-fluid" />
    <div class="info">
      <h3><a href="#">Mayank Raghav</a></h3>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="box">
            ...
            <div class="admin">
              <div class="img">
                <img src="<?php echo base_url();?>main/images/sports-1.jpg"  alt="admin" class="img-fluid" />
              </div>
              <div class="info">
                <h3>mayank</h3>
                <p>Lorem ipsum dolor sit amet.</p>
