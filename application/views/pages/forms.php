			...
			<div class="tabbable-panel">
				<div class="tabbable-line">
					<ul class="nav nav-tabs ">
						...
						<li>
							<a href="#tab_default_2" data-toggle="tab" class="spaces">Training Fitness</a>
						</li>
                        <li>
							<a href="#tab_default_3" data-toggle="tab" class="spaces">Personal Training</a>
						</li>
                        <li>
							<a href="#tab_default_4" data-toggle="tab" class="spaces">Fitness Community</a>
						</li>
						<li>
							<a href="#tab_default_5" data-toggle="tab" class="spaces">Indemnity Agreement</a>
						</li>
					</ul>
