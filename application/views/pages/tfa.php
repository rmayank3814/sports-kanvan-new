                            ...
                            <h5 class="mt-3 mb-4">Measurements: </h5>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control" type="text" name="race" id="race" required>
                                        <!-- <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control" type="text" name="fat" id="fat" required>
                                        <!-- <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control" type="text" name="biceps" id="biceps" required>
                                        <!-- <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control" type="text" name="upper" id="upper" required>
                                        <!-- <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control" type="text" name="mid" id="mid" required>
                                        <!-- <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control" type="text" name="buttocks" id="buttocks" required>
                                        <!-- <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control" type="text" name="hips" id="hips" required>
                                        <!-- <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control" type="text" name="waist" id="waist" required>
                                        <!-- <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control" type="text" name="chest" id="chest" required>
                                        <!-- <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control" type="text" name="calves" id="calves" required>
                                        <!-- <div class="invalid-feedback">
                                            Valid phone number is required.
                                        </div> -->
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control" type="text" name="handed" id="handed" required>
                                        <!-- <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control" type="text" name="posture" id="posture" required>
                                        <!-- <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control" type="text" name="body" id="body" required>
                                        <!-- <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control" type="text" name="loss" id="loss" required>
                                        <!-- <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control" type="text" name="problem" id="problem"  required>
                                        <!-- <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control" type="text" name="rockport" id="rockport" required>
                                        <!-- <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control" type="text" name="resting" id="resting" required>
                                        <!-- <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control" type="text" name="cardio" id="cardio" required>
                                        <!-- <div class="invalid-feedback">
                                            Valid fill is required.
                                        </div> -->
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control" type="text" name="strength" id="strength" required>
                                        <!-- <div class="invalid-feedback">
                                            Valid fill is required.
                                        </div> -->
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control" type="text" name="flexibility" id="flexibility" required>
                                        <!-- <div class="invalid-feedback">
                                            Valid fill is required.
                                        </div> -->
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control" type="text" name="devoted" id="devoted" required>
                                        <!-- <div class="invalid-feedback">
                                            Valid fill is required.
                                        </div> -->
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control" type="text" name="current" id="current" required>
                                        <!-- <div class="invalid-feedback">
                                            Valid fill is required.
                                        </div> -->
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input class="form-control" type="text" name="energy" id="energy" required>
                                        <!-- <div class="invalid-feedback">
                                            Valid fill is required.
                                        </div> -->
                                    </div>
