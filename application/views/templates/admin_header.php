        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="<?=base_url(); ?>index.php/admin/dashboard">
                    <img src="<?=base_url(); ?>main\images\logo\sports-kanvan-logo.png" alt="Kanvan-Sports" height="150px" width="150px" />
                </a>
            </div>
                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        <li class="active has-sub">
                            <a class="js-arrow" href="<?=base_url(); ?>index.php/admin/dashboard">
                                <i class="fas fa-tachometer-alt"></i>Dashboard
                            </a>
                        </li>
                        <li class="active has-sub">
                            <a class="js-arrow" href="<?=base_url(); ?>index.php/banner">
                            <i class="fas fa-edit"></i>Banner Management
                            </a>
                        </li>
                        <li class="active has-sub">
                            <a class="js-arrow" href="<?=base_url(); ?>index.php/admin/event_news">
                            <i class="fas fa-calendar-alt"></i>Event News
                            </a>
                        </li>
                        <li class="active has-sub">
                            <a class="js-arrow" href="<?=base_url(); ?>index.php/blog/blogs">
                    ...
                    <!-- <form class="form-header" action="" method="POST">
                        ...
                        <div class="account-wrap">
                            <div class="account-item clearfix js-item-menu">
                                <div class="image">
                                    <img src="<?=base_url(); ?>main/images/avatar.png" alt="Admin" />
                                </div>
                                <div class="content">
                                ...
                                <div class="account-dropdown js-dropdown">
                                    <div class="info clearfix">
                                        <div class="image">
                                            <a href="#"><img src="<?=base_url(); ?>main/images/avatar.png" alt="Admin" /></a>
                                        </div>
                                        <div class="content">
                                            <h5 class="name">
                                    ...
                                    <div class="account-dropdown__body">
                                        <div class="account-dropdown__item">
                                            <a href="<?=base_url();?>index.php/admin/change_admin_password">
